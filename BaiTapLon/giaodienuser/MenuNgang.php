...
<body>
  <nav>
    <ul>
      <li><a href="../user/Trangchu.php">Trang chủ</a></li>
      <li><a href="#">Menu</a>
        <ul class="vmenu">
          <li><a href="../user/1DS_MonKhaiVi.php">Món khai vị</a>
            <!-- <ul>
              <li><a href="#">Soup</a></li>
          ...
          <li><a href="../user/2DS_ThucDonChinh.php">Thực đơn chính</a>
            <!-- <ul>
          ...
          <li><a href="../user/3DS_monTrangMieng.php">Món tráng miệng</a>
            <!-- <ul>
          ...
          <li><a href="../user/4DS_DoUong.php">Đồ uống</a>
            <!-- <ul>
      ...
      <li><a href="../user/5DS_KhongGianNhaHang.php">Không gian nhà hàng</a></li>
      <li><a href="../user/GioiThieuChiTiet.php">Giới thiệu</a></li>
    </ul>
    <div class="chao">
      <span style = "color: #FFFFFF; padding-left: 7px;">Chào bạn</span>
      <span class = "tim"><?php echo $_SESSION['Hoten']; ?></span>
      |<a href="../user/Dangnhap.php" style = "text-decoration: none; color: white;">
      Đăng xuất</a>
    </div>
  </nav>
</body>
