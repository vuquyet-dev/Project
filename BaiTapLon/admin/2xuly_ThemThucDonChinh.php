...
<body>
    <?php
        ...
        $sql = "SELECT * FROM thucdonchinh WHERE id = '$mamon'";
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            window.location = "2Them_ThucDonChinh.php";</script>';

            die();
        }
        else{
            $chen = "INSERT INTO thucdonchinh(id, tenmon, loaimon, gia, thanhphan, thongtinmon, hinhanh) 
         VALUES ('{$mamon}', '{$tenmon}', '{$loaimon}', '{$dongia}', '{$tpdd}', '{$thongtin}', '{$hinh}')";
            ...
            if($chen){
                ...
                window.location = "2DS_ThucDonChinh.php";</script>';
            }
            else{
