...
<body>
    <?php 
        ...
        if(isset($_POST["cmbQuyen"])) $Quyen = (int)$_POST["cmbQuyen"];
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            if(mysqli_num_rows($result1) > 0) {
                ...
                $chen = "INSERT INTO tbthanhvien (hoten, taikhoan, matkhau, gioitinh, ngaysinh, diachi, dienthoai, email, quyen) 
                         VALUES (N'{$Hoten}', N'{$User}', N'{$Pass}', N'{$Gioitinh}', N'{$Ngaysinh}', N'{$Diachi}', N'{$Dienthoai}', N'{$Email}', N'{$Quyen}')";
