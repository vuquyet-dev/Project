...
<body>
    <?php 
        ...
        $db = "SELECT * FROM monkhaivi WHERE id = '$ID'";
        ...
        if(mysqli_num_rows($query) == 0){
            ...
            <div class="khung">
                ...
                <div class="form-group" style="margin-bottom: 70px;">
                    <h2>SỬA MÓN ĂN</h2>
                    <div id="imgContainer" class="khung-anh"><img src="../images/Monkhaivi/<?php echo $result['hinhanh'];?>" alt="Món ăn"></div>
                </div>
                <form name="suamonan" action="1xuly_SuaMonKhaiVi.php?id=<?php echo $result['id'];?>" method="post" enctype="multipart/form-data">
