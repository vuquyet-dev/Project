...
<body>
    <?php
        ...
        $sql = "SELECT * FROM douong WHERE id = '$mamon'";
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            window.location = "4Them_DoUong.php";</script>';

            die();
        }
        else{
            $chen = "INSERT INTO douong(id, tenmon, loaimon, gia, thanhphan, thongtinmon, hinhanh) 
