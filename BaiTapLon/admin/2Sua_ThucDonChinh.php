...
<body>
    <?php 
        ...
        $db = "SELECT * FROM thucdonchinh WHERE id = '$ID'";
        ...
        if(mysqli_num_rows($query) == 0){
            ...
            <div class="khung">
                ...
                <div class="form-group" style="margin-bottom: 70px;">
                    <h2>SỬA MÓN ĂN</h2>
                    <div id="imgContainer" class="khung-anh"><img src="../images/Thucdonchinh/<?php echo $result['hinhanh'];?>" alt="Món ăn"></div>
                </div>
                <form name="suamonan" action="2xuly_SuaThucDonChinh.php?id=<?php echo $result['id'];?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <?php
                            $db = "SELECT * FROM loaithucdonchinh";
                            $query = mysqli_query($conn, $db);
                            if(mysqli_num_rows($query) > 0) {
                        ?>
