...
<body>
    <?php
        ...
        $sql = "SELECT * FROM montrangmieng WHERE id = '$mamon'";
        ...
        if(mysqli_num_rows($result) > 0)
        {
            ...
            window.location = "3Them_MonTrangMieng.php";</script>';

            die();
        }
        else{
            $chen = "INSERT INTO montrangmieng(id, tenmon, loaimon, gia, thanhphan, thongtinmon, hinhanh) 
